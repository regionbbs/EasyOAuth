...
{
    public class Plurk : OAuthImpl1a,
        OAuthBaseStringBuilder, OAuthSignatureProvider, OAuthAuthorizationHeaderBuilder
    {
        public const string RequestTokenUrl = "http://www.plurk.com/OAuth/request_token";
        public const string AccessTokenUrl = "http://www.plurk.com/OAuth/access_token";
        ...
        public Plurk(string CallbackUrl, string ConsumerKey, string ConsumerSecret) :
        ...
        public Plurk(string CallbackUrl, string ConsumerKey, string ConsumerSecret, string Token, string TokenSecret) :
